...
//   //         if (startObj) {
//   //           startObj = canvas.findById(startObj.id);
//   //           if (startObj.lines.indexOf(obj.id) === -1) {
//   //             startObj.lines.push({ id: obj.id });
//   //             startObj.dirty = true;
//   //           }
//   //         }
//   //         if (endObj) {
//   //           endObj = canvas.findById(endObj.id);
//   //           if (endObj.lines.indexOf(obj.id) === -1) {
//   //             endObj.lines.push({ id: obj.id });
//   //             endObj.dirty = true;
//   //           }
//   //         }
//   //       }
...
//   //         asObjArr.push(canvas.findById(toUpdate.id));
//   //       }
//   //       self.syncObjectChangeToRemote(toUpdate.id, toUpdate);
//   //       toUpdateWidgetArr.push(toUpdate);
//   //       self.syncObjectChangeToRemote(toUpdate.id, toUpdate);
...
//   //       toUpdate.id = state.targetId;
//   //       const subObj = canvas.findById(toUpdate.id);
...
//   //         asObjArr.push(canvas.findById(newwidget.id));
//   //       }
//   //       if (self.getObjectByID(state.targetId)) {
...
//   //       if (toUpdate.objType !== undefined) {
//   //         const type = getNoteType(toUpdate.objType, tempObject.width);
...
//   //       toUpdate
//   //     );
//   //     const tempObject = canvas.findById(toUpdate.id);
//   //     if (tempObject && toUpdate.objType !== undefined) {
//   //       const type = getNoteType(toUpdate.objType, tempObject.width);
//   //       canvas.switchNoteType([tempObject], type, true);
//   //     }
//   //   }
