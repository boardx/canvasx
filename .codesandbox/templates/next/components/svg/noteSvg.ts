...
const stickyNoteSvg =  '%3Csvg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg"%3E%3Cpath d="M42 0H0V37L5 42H42V0Z" fill="%23ff0000" /%3E%3Cpath d="M0 37H5V42L0 37Z" fill="%23000000" /%3E%3Cpath d="M0 37H5V42L0 37Z" fill="yellow" fillOpacity="0.2" /%3E%3C/svg%3E'
